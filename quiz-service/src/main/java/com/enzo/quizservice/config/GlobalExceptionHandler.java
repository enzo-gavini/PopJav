package com.enzo.quizservice.config;
 ...
 * Without it a resource missing downstream surfaces as a 500 instead of a 404.
 * ResponseStatusException is deliberately not handled here so the ownership
 * checks keep answering 403.
 */
